-- Main Client Logic for FiveM Burger Shot Job
-- Handles initialization of all interactive elements and systems
...
CreateThread(function()
    ...
    -- Initialize restaurant blip if enabled
    if Config.Functions.Blip.use then
        CreateBlip({
    ...
    -- Initialize duty system
    InitializeDutySystem(restaurantData)
    
    -- Initialize boss menu
...
function InitializeSupplyShop(restaurantData)
    ...
    for shopId, shopData in pairs(restaurantData.SupplyShop.Positions) do
        ...
        -- Initialize supply shop blip system
...
function InitializeNpcEmployee(restaurantData)
    ...
    for npcId, npcData in pairs(restaurantData.NpcEmployee.Positions) do
        ...
        employeeNpc = createdEmployeeNpc
